    ...
    <>
      <div className="cd-section" id="blogs">
        ...
        <div className="blogs-7">
          <Container>
            <h2 style={{color:'gold'}} className="title">Gallery</h2>
            <Row>
              <Col md="7">
              ...
              <Col md="7">
                <Card className="card-blog card-background">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url(" + require("assets/img/driveway7.jpg") + ")",
                    }}
                  />
                  <CardBody>
                    <div className="content-center">
              ...
              <Col md="7">
                <Card className="card-blog card-background">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url(" + require("assets/img/mmm.jpg") + ")",
                    }}
                  />
                  <CardBody>
                    <div className="content-center">
